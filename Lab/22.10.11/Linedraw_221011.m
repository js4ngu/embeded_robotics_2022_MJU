...
figure;
line(x_data, y_data, z_data, 'LineWidth', 3, 'Color', [0.7;0.9;0.5]);

figure;
handle = line(x_data, y_data, z_data, 'LineWidth', 3, 'Color', [0.7;0.9;0.5]);
set(handle, 'Xdata', x_data, 'Ydata', y_data, 'Zdata', z_data);
grid on;

figure;
handle = quiver3(0,0,0,0,0,0, 'LineWidth', 3, 'Color', [0.7;0.9;0.5]);
set(handle, 'Xdata', 1, 'Ydata', 2, 'Zdata', 3);
grid on;